...
const contactInfo = [ /* unchanged arrays */ ];
const socialLinks = [ /* unchanged arrays */ ];
const departments = [ /* unchanged arrays */ ];
const faqs = [ /* unchanged arrays */ ];

export default function Contact() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-gray-50 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="text-lg px-8 py-4 inline-flex items-center justify-center">
            <Calendar className="mr-2 h-5 w-5" />
            Schedule a Call
          </Button>
          <Button size="lg" variant="outline" className="text-lg px-8 py-4 inline-flex items-center justify-center">
      ...
      <section className="py-16 sm:py-20 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Contact Information</h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-2xl mx-auto">Multiple ways to reach us. Choose what works best for you.</p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="company" placeholder="Enter company name" className="w-full" />
                    </div>
                    <div className="space-y-2">
            ...
            {/* Map & Location */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Visit Our Office</h2>
      ...
      <section className="py-16 sm:py-20 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Department Contacts</h2>
            <p className="text-base sm:text-xl text-gray-600 max-w-2xl mx-auto">Connect directly with the right team for your specific needs</p>
          </div>
              ...
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`tel:${dept.phone}`} className="text-blue-600 hover:underline">{dept.phone}</a>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="py-16 sm:py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-gray-600">Quick answers to common questions. Can't find what you're looking for? Contact us directly.</p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-blue-600 px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6">Ready to Get Started?</h2>
        <p className="text-base sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Don't wait! Let's discuss your project today and see how we can help you achieve your goals.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" variant="secondary" className="text-lg px-8 py-4 inline-flex items-center justify-center">
