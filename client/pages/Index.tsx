  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Numbers That Speak</h2>
            <p className="text-xl text-gray-600">Building success stories one project at a time</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <EnhancedCard
                key={index}
                className="text-center p-8 bg-white/80 backdrop-blur-sm border border-white/50"
                hover={true}
                glow={true}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <CheckCircle className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-gray-700 text-lg">Client-focused development approach</span>
                </div>
                <div className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <CheckCircle className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-gray-700 text-lg">Comprehensive training programs</span>
                </div>
                <div className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <CheckCircle className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-gray-700 text-lg">Industry-leading expertise</span>
                </div>
                <div className="flex items-center group">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-400 to-red-500 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <CheckCircle className="h-5 w-5 text-white" />
                  </div>
                  <span className="text-gray-700 text-lg">24/7 support and maintenance</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <EnhancedCard
                  className="p-8 bg-gradient-to-br from-blue-500/5 to-blue-600/10 border border-blue-200/50"
                  hover={true}
                ...
                />
                <EnhancedCard
                  className="p-8 bg-gradient-to-br from-purple-500/5 to-purple-600/10 border border-purple-200/50"
                  hover={true}
              ...
              <div className="space-y-6 mt-8">
                <EnhancedCard
                  className="p-8 bg-gradient-to-br from-green-500/5 to-green-600/10 border border-green-200/50"
                  hover={true}
                ...
                />
                <EnhancedCard
                  className="p-8 bg-gradient-to-br from-orange-500/5 to-orange-600/10 border border-orange-200/50"
                  hover={true}
                  icon={<Code2 className="h-10 w-10 text-orange-600" />}
                  title="Modern Tech"
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-0 w-96 h-96 bg-gradient-to-r from-blue-300/20 to-purple-300/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-gradient-to-r from-cyan-300/20 to-teal-300/20 rounded-full blur-3xl"></div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <EnhancedCard
                key={index}
                className={`text-center p-8 bg-white/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group`}
                hover={false}
              >
                <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${service.gradient} p-4 mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
          ...
          <div className="text-center mt-16">
            <Link to="/services">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300">
                View All Services
